...
#define __TEXTURE_2D_URI__ ((char*)"Res/Content/Texture/")
#endif
...
#define STB_IMAGE_IMPLEMENTATION	// Define stb lib implementation
#include <stb_image.h>	// For high quiality textures
