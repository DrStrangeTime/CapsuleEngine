...
public:
	...
	inline void Create(GLuint shader_program)
	{
		...
		Content::_map->AddActor(new DirectionalLight(shader_program, glm::vec3(3.0f, 5.0f, 5.0f), glm::vec3(1.0f, 0.5f, 0.3f), 1.3f), LIGHT);
		Content::_map->AddActor(new PointLight(glm::vec3(0.0f, 4.0f, 0.3f), glm::vec3(1.0f, 0.0f, 0.0f)), LIGHT);
		...
		_u_mat = glGetUniformLocation(shader_program, "mod");
	}
